...
#'
#' \itemize{ \item \code{\link{as_utf8}} attempts to convert character data to
...
#'
#' \item \code{\link{utf8_normalize}} converts text to Unicode composed normal
...
#'
#' \item \code{\link{utf8_format}} formats a character vector by truncating to
...
#' characters);
#'
#' \item \code{\link{output_ansi}} and \code{\link{output_utf8}} test for the
