...
```
Error in text_filter(drop_punct = TRUE, drop = stopwords_en): could not find function "text_filter"
```
...
```
Error in term_stats(lines2, f): could not find function "term_stats"
```
